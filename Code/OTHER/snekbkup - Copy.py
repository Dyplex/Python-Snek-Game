...
def livecounter(label, remaining):
    ...
    if remaining <= 0:
        label.config(text="Time's up!")
        img = Image.open("assets/livereactions/NEW/liveSucc.gif")
        print("Time's up!")
    else:
        label.config(text="Time left: {}".format(remaining))
        remaining -= 1
        if remaining < 10:
            ...
            img = Image.open("assets/livereactions/NEW/liveD.gif")
            print("D")
        elif remaining < 20:
            img = Image.open("assets/livereactions/NEW/liveC.gif")
            print("C")
        elif remaining < 25:
            img = Image.open("assets/livereactions/NEW/liveB.gif")
            print("B")
        elif remaining < 30:
            img = Image.open("assets/livereactions/NEW/liveA.gif")
            print("A")
        elif remaining < 55:
            img = Image.open("assets/livereactions/NEW/liveS.gif")
            print("S")
        else:
            return
        #img = img.resize((50, 50), Image.ANTIALIAS)
